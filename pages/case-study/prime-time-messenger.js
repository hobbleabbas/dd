        ...
        <div>
            ...
            <div className="my-20 sm:my-24 flex justify-center">
                <div className="w-2/3  grid grid-cols-1 sm:grid-cols-3 gap-16">
                    <a className="text-center relative" target="_blank" href="https://youtube.com/shorts/IAqulXdt6m4?feature=share" rel="noreferrer">
                    ...
                    <a className="text-center relative" target="_blank" href="https://youtube.com/shorts/CtBQdOH9yCU?feature=share" rel="noreferrer">
                    ...
                    <a className="text-center relative" target="_blank" href="https://youtube.com/shorts/_SSKGcIrFv8?feature=share" rel="noreferrer">
